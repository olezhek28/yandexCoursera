...
{
	SimpleVectorNoCopy<int> empty;
	ASSERT_EQUAL(empty.Size(), 0u);
	ASSERT_EQUAL(empty.Capacity(), 0u);
	ASSERT(empty.begin() == empty.end());

	SimpleVectorNoCopy<string> five_strings(5);
...
void TestNoCopy()
{
	SimpleVectorNoCopy<StringNonCopyable> strings;
